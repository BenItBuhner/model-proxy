...
def test_openai_endpoint_routes_to_anthropic(client, mock_env_vars, mock_anthropic_response):
...
def test_anthropic_endpoint_routes_to_openai(client, mock_env_vars, mock_openai_response):
...
def test_anthropic_endpoint_with_parameters(client, mock_env_vars, mock_anthropic_response):
...
def test_cross_provider_routing_openai_to_anthropic(client, mock_env_vars, mock_anthropic_response):
...
def test_cross_provider_routing_anthropic_to_openai(client, mock_env_vars, mock_openai_response):
