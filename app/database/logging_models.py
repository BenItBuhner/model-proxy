...
class RequestLog(Base):
    ...
    request_id = Column(String, unique=True, nullable=False, index=True)  # UUID for request tracking
    ...
    requested_model = Column(String, nullable=False, index=True)  # Model requested by client
    resolved_provider = Column(String, nullable=False, index=True)  # Actual provider used
    ...
    response_usage = Column(JSON)  # Token usage: {prompt_tokens, completion_tokens, total_tokens}
