...
def extract_usage_from_response(response_dict: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    """
...
def extract_response_content(response_dict: Dict[str, Any], is_openai_format: bool = True) -> Optional[str]:
    """
