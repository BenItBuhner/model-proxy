...
def format_openai_error(status_code: int, message: str, error_type: str = None) -> Dict[str, Any]:
    """
...
def format_anthropic_error(status_code: int, message: str, error_type: str = None) -> Dict[str, Any]:
    """
...
def create_provider_error_response(
    ...
    if provider_name == "openai":
        ...
        # Default format
        error_detail = {"error": {"message": message, "type": error_type or "api_error"}}
